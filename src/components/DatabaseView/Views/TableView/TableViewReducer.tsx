...
// export const initialTableViewState: ViewStateType = {
...
// 	}),
// } satisfies Record<string, (state: ViewStateType, action: ActionType) => ViewStateType>
//
...
// 	payload: any
// }
//  const reducer = (state: ViewStateType, action: ActionType): ViewStateType =>
// 	actions[action.type]
// 		? actions[action.type](state, action)
// 		: state
//
// export const useTableViewReducer = (initialState: ViewStateType): ViewStateType => {
